...
-	**Agent conversationnel : interroger une base de documents textuels (pdf, code, etc…) (retrieval augmented generation)**.
...
| Etalab | Albert | LabIA | Production |

Projet mené par le LabIA de la DINUM. Pour aller plus loin, consulter :
    - [S'inscrire à l'Albert](https://albert.etalab.gouv.fr/signup)
    - [Albert github](https://github.com/etalab-ia/albert) : Outils de déploiements des modèles Albert
    - [Albert hugging face](https://huggingface.co/AgentPublic)
    - [Albert API](https://github.com/etalab-ia/albert-api) - API
...
-	**Extraire des données à partir de documents textuels pour construire une nouvelle base de données**
