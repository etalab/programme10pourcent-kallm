...
Ce chapitre introduit les principales briques et outils utiles ainsi que
différents contextes de déploiement. Elle est découpée en 4 parties :

1. :nut_and_bolt: [Outillage minimal](./1_Outillage_minimal.qmd): Description des principaux
composants d'une architecture d'inférence, ainsi qu'un premier exemple
d'implémentation de ces outils
1. :wrench: [Outillage avancé](./2_Outillage_avance.qmd): Description et implémentation
d'outillage avancé
1. :cloud: [Infrastructures externalisées pour l'administration](./3_Infras_administrations.qmd): Premiers éléments sur la mise
en place d'une infrastructure externalisée ou semi-externalisée.
1. :factory: [Déploiement sur site à grande échelle](./4_Socle_Production.qmd): Orchestration et mise en place
