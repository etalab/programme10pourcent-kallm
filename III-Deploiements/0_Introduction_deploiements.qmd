...
projet LLM, ainsi que des pistes de réflexion l'infrastructure sous-jacente
...
1. :factory: [Service LLM production](./2_Service_LLM_production.qmd): Orchestration et mise en place d'une infrastructure d'inférence
...
1. :factory: [Déploiement sur site à grande échelle](./4_Socle_Production.qmd):
 sur site à grande échelle
